      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-20 text-center px-4 max-w-5xl mx-auto w-full">
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-charcoal-100 mb-12 max-w-2xl mx-auto"
          >
            La première plateforme unifiée pour l'hébergement et les services.
            Trouvez votre chambre d'hôtes, chefs culinaires, guides touristiques, et
            bien plus encore.
          </motion.p>
